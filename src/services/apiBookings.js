...
export async function getAllBookings(filterOptions, sortOptions, page) {
   ...
   if (filterOptions) {
      query.eq(filterOptions.field, filterOptions.value);
   }
   //TODO: server side SORTING
   if (sortOptions) {
      // query.eq(sortOptions.field, sortOptions.direction);
      query.order(sortOptions.field, {
