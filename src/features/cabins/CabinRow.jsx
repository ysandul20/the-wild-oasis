...
function CabinRow({ cabin }) {
   ...
   const { mutate: duplicateCabin, isCreating } = useCreateCabin();
      ...
      <>
         <TableRow role="row">
            ...
            <div style={{ display: "flex", gap: "1rem" }}>
               ...
               <button onClick={() => setShowEditForm((cur) => !cur)}>
                  Edit
               </button>
               <button onClick={() => setShowDeleteForm((cur) => !cur)}>
                  Delete
               </button>
            </div>
         </TableRow>
         {showEditForm && (
            <Modal onCloseModal={setShowEditForm}>
               <UpdateCabinForm
                  cabinData={cabin}
